...
class RequestItem:
    ...
    def add_event(self, L1, L2, L3, L4, CodAppl, NomeSoftware, OMRLabCode, CollectionName, ApplName):
        ...
        if os.path.exists(test_script_path):
            ...
            textModTest.replace_placeholders(L1, L2, L3, L4, CodAppl, NomeSoftware, OMRLabCode, CollectionName, ApplName)
    ...
    def add_request_body(self, json_file_path, L1, L2, L3, L4, CodAppl, NomeSoftware, OMRLabCode, CollectionName, ApplName):
        try:
